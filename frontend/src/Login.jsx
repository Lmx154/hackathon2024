    ...
    <body className={styles.bodylogin}>
        ...
        <header className={styles.header}>
                ...
                <div className={styles.navrightsection}>
                    ...
                    <div><button type='button' className={styles.signinbubble} onClick={() => navigate('/Signup')}>Sign Up</button></div>
                </div>
            </header>
        <div className={styles.wrapper}>
            <form action="">
                ...
                <div className={styles.rememberforgot}>
                    ...
                    <a href='/Forgotpass' onClick={() => navigate('/Forgotpass')}>Forgot password</a>
                </div>
